...
fn cix_sky1_summary(sensors: &[SensorReading]) -> Vec<SensorSummary> {
    let cpu = ["cpu-b0", "cpu-b1", "cpu-m0", "cpu-m1"]
        .into_iter()
...
mod tests {
    ...
    fn cix_sky1_summary_uses_acpi_thermal_zone_labels() {
        ...
        assert_eq!(BoardProfile::CixSky1.per_cpu_temperature(2, &sensors), None);
    }
}
